...
def dessin(beta, epsilon, tau, kappa, alpha, sigma) :
  ...
  if kappa == "quasi nu" : bush(a, b), bush(c, d), bush(e, f), bush(g, h)
  if kappa == "recouvert" : tree(a, b), tree(c, d), tree(e, f), tree(g, h)
...
print(dessin(300, 10, "sable", "recouvert", "protections", 3.6))
